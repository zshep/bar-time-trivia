export default function makeTriviaSession() {
    ...
    return (
        <div className="d-flex flex-column text-center">
            ...
            <p className="m-5">Create a complete Trivia Session choosing up to 5 rounds. Decide what kind of questions you will use and if you will use hints or not</p>
            <form>
